...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.yhsy8it.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Speedway Shocase Server is running");
});

app.listen(port, () => {
  console.log(`Speedway Shocase Server is running on port : ${port}`);
});
